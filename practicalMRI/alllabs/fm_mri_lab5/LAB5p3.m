...
%add pulse parts together
 rfPulse = [rfPulse1, rfPulse3,rfPulse2, rfPulse4, rfPulse2, rfPulse4, rfPulse5];
rfPulseG = [rfPulse1, rfPulse3,rfPulse2, rfPulse4, rfPulse2, rfPulse4,rfPulse6];
...
%what kind of tissue contrast did we get? compare to 5p2

% we got mixed contrast weighting 

display('img.mat') % we got from 5p2

%Change the phase encoding gradients to obtain a center-out ordering, i.e. do you think a turbo factor of 48 is reasonable?

% I think it is resonibly fast.  

...
for j=mxy
    t2starmxy= exp(-tet2star/mxy1); % need to edit this to be one column 
end
...
%posZ_v =posZ';
%fit data
f = fit( t2starmxy, tet2star, 'rat23' );
%Plot your fit and the data.
figure
plot( f, t2starmxy, tet2star )
...
% load T2 results, how much shorter is T2*? fit same equation it is .9 us
% shorter
f = fit( t2starmxy, tet2star, 'rat23' );
%Plot your fit and the data.
figure
plot( f, t2mxy, tet2star )